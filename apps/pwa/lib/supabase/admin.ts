 ...
 *
 * Mirrored from the root app's `lib/supabase/admin.ts` — apps/pwa is a
 * separate Next.js process/deployment but talks to the same Supabase
 * project/database, so it needs its own copy of this plumbing.
 */
