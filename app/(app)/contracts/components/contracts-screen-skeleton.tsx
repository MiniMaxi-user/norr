...
/**
 * Suspense fallback for `ContractsScreen`, shaped like the eventual content
 ...
 * `app/(app)/work-orders/components/work-orders-screen-skeleton.tsx`. The
 ...
 */
export function ContractsScreenSkeleton() {
  return (
