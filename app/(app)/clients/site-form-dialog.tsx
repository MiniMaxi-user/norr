      ...
      <form action={formAction}>
        ...
        <Dialog.Body>
          <Stack gap="md">
            ...
            <FormField label="Name" name="name" defaultValue={site?.name} required errors={state.fieldErrors?.name} />
            <FormField
            ...
            <FormField label="Country" name="country" defaultValue={site?.country} errors={state.fieldErrors?.country} />
            <FormField
              label="Latitude"
              name="latitude"
              type="number"
