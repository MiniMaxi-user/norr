 ...
 * this" only to be rejected by RLS.
 *
        ...
        <Card>
          <Stack gap="sm">
            ...
            {/* Site has no detail page of its own to link to (unlike
                Client/Asset/Contract) — its formatted address is already the
                clearest available representation. */}
            <ReadOnlyField label="Site" value={site ? formatSiteAddressShort(site) ?? "—" : "—"} />
            <ReadOnlyField
              label="Asset"
